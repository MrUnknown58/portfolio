...
export default function Contact() {
  ...
  return (
    <>
      <Box className="bg-[#140f23] w-[100%] md:h-[623px] h-[795px] md:py-10 md:px-0 md:pr-10 py-14 px-[2rem] flex flex-col">
        <Box className="flex flex-col md:flex-row justify-between" component={motion.div}>
          <Link to="/">
